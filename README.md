...
- **MUI** для окремих UI-елементи
- **Framer Motion** для анімацій
- **nextjs-toploader** для top loading progress
...
app/
  (main)/
    ...
    travellers/           # сторінка мандрівників
      [id]/               # сторінка окремого мандрівника
  auth/
  ...
  profile/
    ...
    stories/edit/[id]/    # редагування історії
...
- редагування профілю;
- зміна email через verification flow;
- видалення профілю;
...
- Оля Полюхович - Team Lead / Developer
- Олеся Цатурян - Scrum Master / Developer
- Костянтин Головчик - PM / Developer
- Володимир Нестеренко - Developer
- Віталій Іщенко - Developer
- Максим Хлиста - Developer
- Ростислав Мясников - Developer
- Іван Олефіренко - Developer
- Елор Олабі - Developer
- Артемій Головко - Developer
